...
class TutorialFSM(FSM):
    ...
    def __init__(self, air, zones, avId):
        ...
        self.tutorialTom = NPCToons.createNPC(self.air, 30000, tutorialTomDesc, self.zones.SHOP, 0)
        self.tutorialTom.setTutorial(1)

        hqHarryDesc = (
            -1, TTLocalizer.TutorialHQOfficerName, ('dls', 'ms', 'm', 'm', 6, 0, 6, 6, 0, 10, 0, 10, 0, 9), 'm', 1,
            NPCToons.NPC_HQ)
        self.hqHarry = NPCToons.createNPC(self.air, 30002, hqHarryDesc, self.zones.HQ, 0)
