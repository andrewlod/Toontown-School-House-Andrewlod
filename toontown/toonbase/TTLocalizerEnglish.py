...
lNewPlayground = "Silly Beach"
lRestaurant = "Daisy's Restaurant"
lToonHQ = 'Toon HQ'
...
GlobalStreetNames = {30000: ('to', 'on', 'Tutorial Terrace'),
...
NewPlayground = ('to', 'in', lNewPlayground)
Restaurant = ('to', 'in', lRestaurant)
...
HolidayNamesInCalendar = {1: ('Summer Fireworks', 'Celebrate Summer with a fireworks show every hour in each playground!'),
 ...
 8: ('Toon Species Election', 'Vote on the new Toon species! Will it be Goat?'),
