...
from toontown.hood.NPHoodDataAI import NPHoodDataAI
from toontown.hood.DRHoodDataAI import DRHoodDataAI
...
class ToontownAIRepository(ToontownInternalRepository):
    ...
    def createZones(self):
        ...
        # New Playground
        self.zoneTable[ToontownGlobals.NewPlayground] = (
            (ToontownGlobals.NewPlayground, 1, 0),
        )
        self.createHood(NPHoodDataAI, ToontownGlobals.NewPlayground)

        # New Playground
        self.zoneTable[ToontownGlobals.Restaurant] = (
            (ToontownGlobals.Restaurant, 1, 0),
        )
        self.createHood(DRHoodDataAI, ToontownGlobals.Restaurant)
