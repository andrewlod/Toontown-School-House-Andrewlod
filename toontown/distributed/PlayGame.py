...
from toontown.hood import NPHood
from toontown.hood import DRHood
...
class PlayGame(StateData.StateData):
    ...
    Hood2ClassDict = {ToontownGlobals.ToontownCentral: TTHood.TTHood,
     ...
     ToontownGlobals.NewPlayground: NPHood.NPHood,
     ToontownGlobals.Restaurant: DRHood.DRHood,
    ...
    Hood2StateDict = {ToontownGlobals.ToontownCentral: 'TTHood',
     ...
     ToontownGlobals.NewPlayground: 'NPHood',
     ToontownGlobals.Restaurant: 'DRHood',
    ...
    def __init__(self, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('PlayGame', [State.State('start', self.enterStart, self.exitStart, ['quietZone']),
         ...
         State.State('NPHood', self.enterNPHood, self.exitNPHood, ['quietZone']),
         State.State('DRHood', self.enterNPHood, self.exitNPHood, ['quietZone']),
    ...
    def enterNPHood(self, requestStatus):
        self.accept(self.hoodDoneEvent, self.handleHoodDone)
        self.hood.enter(requestStatus)
