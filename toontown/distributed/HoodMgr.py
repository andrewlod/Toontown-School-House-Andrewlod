...
class HoodMgr(DirectObject.DirectObject):
    ...
    dropPoints = {ToontownGlobals.DonaldsDock: ([-28.0,
     ...
     ToontownGlobals.OutdoorZone: ([-165.8,
                                   ...
                                   [23,
                                    ...
                                    0,
                                    0]),
     ToontownGlobals.NewPlayground: ([87.887,
                                    2.304,
                                    9.847,
                                    96,
                                    0,
                                    ...
                                    0,
                                    0]),
     ToontownGlobals.Restaurant: ([23.887,
                                    31.781,
                                    0.025,
                                    25,
                                    0,
    ...
    hoodName2Id = {'dd': ToontownGlobals.DonaldsDock,
     ...
     'np': ToontownGlobals.NewPlayground,
     'dr': ToontownGlobals.Restaurant}
    hoodId2Name = {ToontownGlobals.DonaldsDock: 'dd',
     ...
     ToontownGlobals.NewPlayground: 'np',
     ToontownGlobals.Restaurant: 'dr'}
    DefaultDropPoint = [0,
     0,
     0,
     0,
