...
class DistributedToon(DistributedPlayer.DistributedPlayer, Toon.Toon, DistributedSmoothNode.DistributedSmoothNode, DelayDeletable):
    ...
    def setRainbow(self, rainbow):
        ...
        if self.rainbow and self.style != None:
            taskMgr.doMethodLater(0.2, self.updateRainbow, "rainbowUpdate")
        else:
            taskMgr.remove("rainbowUpdate")

    def updateRainbow(self, task):
        r = random.randint(0,10)
        self.style.headColor = r
        self.style.armColor = r
        self.style.legColor = r
    ...
    def setDefaultZone(self, zoneId):
        if zoneId >= 30000 and zoneId < 32000:
            zoneId = zoneId + 2000
        try:
