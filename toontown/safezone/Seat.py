...
class Seat(StateData.StateData):
    ...
    def load(self):
        self.parentFSM.getStateNamed('seatBlock').addChild(self.fsm)
    ...
    def enter(self):
        ...
        if base.localAvatar.hp > 0:
            messenger.send('enterseatOK_%d_%d' % (self.tableNumber, self.seatNumber))
    ...
    def enterBoarding(self, nodePath, side):
        ...
        self.cameraBoardTrack = LerpPosHprInterval(camera, 1.5, Point3(220.4072 * side, 60, 155.8667), Point3(heading, -30, 0))
    ...
    def enterTrolleyLeaving(self):
        ...
        self.acceptOnce('seatDone', self.handleSeatDone)
        return None
    ...
    def exitTrolleyLeaving(self):
        ...
        return self.notify.debug('handling seat done event')
