...
import ToonHood
from toontown.safezone import DRSafeZoneLoader
from toontown.toonbase.ToontownGlobals import *
import SkyUtil

class DRHood(ToonHood.ToonHood):

    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ToonHood.ToonHood.__init__(self, parentFSM, doneEvent, dnaStore, hoodId)
        self.id = Restaurant
        self.safeZoneLoaderClass = DRSafeZoneLoader.DRSafeZoneLoader
        self.storageDNAFile = 'phase_8/dna/storage_DR.dna'
    ...
    def load(self):
        ...
        self.parentFSM.getStateNamed('DRHood').addChild(self.fsm)
        self.fog = Fog('DRFog')

    def unload(self):
        self.parentFSM.getStateNamed('DRHood').removeChild(self.fsm)
