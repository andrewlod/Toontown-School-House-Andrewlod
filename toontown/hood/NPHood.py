...
import ToonHood
from toontown.safezone import NPSafeZoneLoader
from toontown.toonbase.ToontownGlobals import *
from toontown.racing import DistributedVehicle
import SkyUtil

class NPHood(ToonHood.ToonHood):

    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ToonHood.ToonHood.__init__(self, parentFSM, doneEvent, dnaStore, hoodId)
        self.id = NewPlayground
        self.safeZoneLoaderClass = NPSafeZoneLoader.NPSafeZoneLoader
        self.storageDNAFile = 'phase_6/dna/storage_NP.dna'
    ...
    def load(self):
        ...
        self.parentFSM.getStateNamed('NPHood').addChild(self.fsm)
        self.fog = Fog('NPFog')

    def unload(self):
        self.parentFSM.getStateNamed('NPHood').removeChild(self.fsm)
